...
namespace CraftServer {
	...
	public:
		...
		std::string toString() override {
			try {
				...
				CS_LOG_ERROR(CS_LOG_ROOT()) << "ConfigVar::toString exception"
			...
			const T& default_value, const std::string& description = "")
		{
			...
			if(it != GetDatas().end()) {
				...
				if(tmp) {
					...
					CS_LOG_ERROR(CS_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
	...
	private:
		...
		// static std::map<std::string, int> s_test;
		// static ConfigVarMap s_datas;
	};
